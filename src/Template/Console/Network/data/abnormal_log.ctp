...
<div class="wrap-nav-right hosts-content">
    <?= $this -> element('network/lists/left_nav', ['active_action' => 'abnormal_log','id'=>$_data['0']['H_ID']]); ?>
        <div class="normal-log hosts-right clearfix host-static">
            <div class=" <?php if(isset($action)){ if($action == 'desktop' ){ echo 'wrap-nav-right-left';}} ?>">
                <div class="">
                    <div class="">
                        <h5 class="title">  
                            <?= $this -> element('network/data/breadcrumb', ['breadcrumbTitle' => '异常日志','biz_tid' => $_data['0']['Biz_tid']]); ?>
                        </h5>
                    </div>
		...
		?>
                    ...
                    <div id="navigation">
                    <a href="<?= $this -> Url -> build(['controller' => 'network', 'action' => 'getTask',$_data['0']['H_ID'],'excp','10','2']); ?>"></a>
                    </div>
