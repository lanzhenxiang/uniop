...
<div class="wrap-nav-right" ng-app>
    <div class="container-wrap  wrap-buy">
       <a href="<?= $this->Url->build(['controller'=>'network','action'=>'lists','fics']); ?>" class="btn btn-addition">返回媒体存储列表</a>
...
$(function() {
    $('#btnBuy').on('click',function(){
        ...
        $.ajax({
            type:"post",
            url:"<?= $this -> Url -> build(['prefix' => 'console', 'controller' => 'ajax', 'action' => 'network', 'fics', 'checkVolName']) ?>",
            async:false,
            data:{
