    ...
    <div class="wrap-nav-right">
       ...
       <div class="wrap-manage">
            ...
            <!-- 跨租户新建主机 -->
            <?=$this->element('switchDepartment',['callback_url' => $this->Url->build(['controller' => 'network', 'action' => 'add', 'hosts']),'typeName'=>'主机'])?>
            <!-- 跨租户新建主机 -->
              ...
              <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                      <?php foreach($_deparments as $value) { ?>
                         <li><a href="#" onclick="departmentlist(<?php echo $value['id'] ?>, '<?php echo $value['name'] ?>', 'hosts')"><?php echo $value['name'] ?></a></li>
                      <?php }?>
                </ul>
              </div>
              <?php }?>
                 <div class="dropdown">
    			  	VPC:
    					<a href="#" class="dropdown-toggle btn btn-addition text-right" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
    						<span class="pull-left" id="vpcCode" val="">全部</span>
    					<span class="caret"></span>
    				</a>
    				<ul class="dropdown-menu" id="vpcInfo">
    					<li><a href="javascript:;" onclick="selectVpc(0,'','全部')">全部</a></li>
    					<?php if(isset($vpcData)){
    						foreach($vpcData as $v) {
    					?>
    						 <li><a href="#" onclick="selectVpc(<?php echo $v['id'] ?>,'<?php echo $v['code'] ?>','<?php echo $v['name'] ?>')"><?php echo $v['name'] ?></a></li>
    					<?php }} ?>
    				</ul>
    			</div>   
    			 <div class="dropdown">
    	 ...
    	 data-url="<?= $this -> Url -> build(['prefix' => 'console', 'controller' => 'ajax', 'action' => 'network', 'hosts', 'lists','?'=>['department_id'=>$_default["id"]]]); ?>"
    	 data-unique-id="H_ID">
    	 <thead>
    	   <tr>
    ...
    <div class="chart-main">
      ...
      <div class=" clearfix">
    	<div  class="chart-box pull-left">
    	  <p>CPU</p>
    	  <div>
    		<canvas id="canvas1" height="120" width="200"></canvas>
    	  </div>
      ...
      <!--   <div  class="chart-box pull-left">
    	...
    	<div  class="chart-box pull-left">
    	  <p>磁盘</p>
    	  <div>
    		<canvas id="canvas3" height="120" width="200"></canvas>
    	  </div>
    	...
    	<div  class="chart-box pull-left">
    	  <p>网络</p>
    	  <div>
    		<canvas id="canvas4" height="120" width="200"></canvas>
    	  </div>
    ...
    <div class="context-menu" id="context-menu">
    	...
    	<!-- <li><a href="javascript:void(0);"><i class="icon-tag"></i> 标签</a></li> -->
			 ...
			 <li id="sysdisks"><a href="javascript:void(0);"> <i class="icon-inbox"></i> 系统盘扩容
			 </a>
			 </li>
			 <?php } ?>
	   ...
	   <li ><a href="javascript:void(0);" id="ecsUnbindEip"><i class="icon-minus"></i> 解绑EIP</a></li>
            <?php } ?>
    		<!-- <li>
