            ...
            <div class="modal-body clearfix">
                <form method="post" id="addfrom" class="form-horizontal">
                    <div class="pull-left fire-left">
                        ...
                        <div class="modal-form-group">
                            ...
                            <div class="form-group">
                                <select name="action-type" id="action-type" onchange="changeActionType()">
                                    <option value="cidr" selected="selected">cidr</option>
                                    <?php if(isset($data['security_group_extend']['fusionType']) && $data['security_group_extend']['fusionType'] != 'vmware' ) :?>
                                    <option value="securitygroup">securitygroup</option>
                                    <?php endif;?>
                                </select>
                            </div>
                        </div>
                        <div class="modal-form-group" id="object_div">
                            <div class="clearfix">
                                <label>操作对象:</label>
                                <div class="form-group">
                        ...
                        <div class="modal-form-group" id="other_srcurity_div"  style="display:none">
                            <label>安全组:</label>
                            <div class="bk-select-group">
                                <select name="code" id="other_srcurity_code">
                                <?php foreach ($security_data as $v) {?>
...
function changeActionType(){
    ...
    if(type=='cidr'){
        $('#rule-ip').val('');
        $('#other_srcurity_div').css({display:'none'});
        $('#object_div').css({display:'block'});
    }else{
        $('#rule-ip').val('');
        $('#other_srcurity_div').css({display:'block'});
...
//                                     e=$.parseJSON(e);
    ...
    function notifyCallBack(value){
        if(value.MsgType=="success"||value.MsgType=="error"){
          if(value.Data.method=="security_group_add_rule"||value.Data.method=="security_group_rule_del"){
        	  refreshTable();
          }
        }
      }
