	...
	<div class="container-wrap  wrap-buy">
		...
		<div class="clearfix buy-theme" ng-controller="hostListService">
			<div class="pull-left theme-left">
				<div class="">
					<table>
						<input type="hidden" value='8' id="txtgoods_id"></input>
						<tr>
							...
							<td class="row-message-right">
								<div class="ng-binding">
									<div class="clearfix">
										...
										<div class="bk-form-row-cell">
											<input id="txtname" type="text" style="width:15%;margin:0 5px;" />—<input id="txtname" type="text" style="width:5%; margin: 0 5px;"/>至<input id="txtname" type="text" style="width:5%;margin: 0 5px;"/>
											<p><i class="icon-info-sign"></i>&nbsp;实例名称由主名、短横线、数字序号构成，其中，主名由8个英文字母构成，序号范围从1到999;例：abcdefgh-12</p>
										</div>
									</div>							
									<div class="clearfix">
									...
									<div class="clearfix">
										...
										<div class="bk-form-row-cell">
											<ul class="clearfix city" style="margin-bottom:4px" ng-repeat="host in hosts | filter:current">
												<li ng-repeat="os in host.DesktopOs" ng-class="{active:$first}" ng-click="changeOs(os)">
													{{os.name}}
												</li>
											</ul>
											<div ng-repeat="host in hosts | filter:current">
												<ul class="list-card list-card-primary" ng-repeat="os in host.DesktopOs | filter:currentOs">
							...
							<td class="row-message-right">
								<div class="ng-binding">
									...
									<div class="pwd-content">
										<div class="clearfix">
											<label for="" class="pull-left ">帐号:</label>
											<div class="bk-form-row-cell">
												<select>
													<option>111</option>
												</select>	
