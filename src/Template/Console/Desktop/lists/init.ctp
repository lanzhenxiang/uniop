...
<div class="wrap-nav-right">
  ...
  <div class="wrap-manage">
    <div class="top">
      <span class="title"><a href="initCopy">管理服务列表</a></span>
    ...
    <div class="center clearfix">
      ...
      href="<?= $this->Url->build(['controller'=>'desktop','action'=>'add','init']) ?>"><i
      class="icon-plus"></i>&nbsp;&nbsp;新建</a>
      <?php } ?> -->
      <!-- 跨租户新建桌面套件 -->
          <?=$this->element('switchDepartment',['callback_url' => $this->Url->build(['controller' => 'desktop', 'action' => 'add', 'init'])])?>
      <!-- 跨租户新建桌面套件 -->
