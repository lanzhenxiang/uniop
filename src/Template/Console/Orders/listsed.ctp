        ...
        <div class="section-header clearfix order-manage">
            ...
            <div class="dropdown pull-right">
                ...
                <ul class="dropdown-menu" id="agent_two">
                    <li><a href="<?= $this->Url->build(['prefix' => 'console', 'controller' => 'orders', 'action' => $this->request->params['action'],$start,$end,0,$search]); ?>?search=<?=$search?><?php if(isset($_GET['file_position'])&&$_GET['file_position']=='admin'){echo '&file_position=admin';}?>">全部</a></li>

                    <li><a href="<?= $this->Url->build(['prefix' => 'console', 'controller' => 'orders', 'action' => $this->request->params['action'],$start,$end,-1,$search]); ?>?search=<?=$search?><?php if(isset($_GET['file_position'])&&$_GET['file_position']=='admin'){echo '&file_position=admin';}?>" >未完结</a></li>

                    <li><a href="<?= $this->Url->build(['prefix' => 'console', 'controller' => 'orders', 'action' => $this->request->params['action'],$start,$end,1,$search]); ?>?search=<?=$search?><?php if(isset($_GET['file_position'])&&$_GET['file_position']=='admin'){echo '&file_position=admin';}?>" >已完结</a></li>
                </ul>
            </div>
