		...
		<div class="center clearfix">
			<div class="pull-left">
				...
				<?php if (in_array('cmop_global_sys_admin', $this->Session->read('Auth.User.popedomname'))) { ?>
					<input style="line-height: 24px;height: 24px;width: 160px;margin-left:8px;margin-right:20px;" type="text" id="txtsearch" value="<?=$name?>" name="search" placeholder="搜索防火墙名称、防火墙code">
				<?php }?>
				<?php if (in_array('cmop_global_sys_admin', $this->Session->read('Auth.User.popedomname'))) { ?>
				计费方式&nbsp;
			...
			<div class="center clearfix bot">
				...
				<thead>
					<tr>
						...
						<th data-field="name" >防火墙名</th>
						<th data-field="code" >防火墙code</th>
