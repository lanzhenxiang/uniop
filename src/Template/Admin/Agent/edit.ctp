...
<div class="content-body clearfix">
    ...
    <form class="form-horizontal" id="agent-form" action="<?php echo $this->Url->build(array('controller' => 'Agent','action'=>'edit')); ?>" method="post">
        <div>
            <!-- Nav tabs -->
            <!-- Tab panes -->
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="home">
                    ...
                    <div class="form-group">
                        <label for="agent_name" class="col-sm-2 control-label">厂商名称</label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="agent_name"  id="agent_name" placeholder="厂商名称" value="<?php if(isset($agentinfo['agent_name'])){ echo $agentinfo['agent_name'];}  ?>">
                            ...
                            <input type="hidden" class="form-control" name="parentid"  id="parentid" value="0">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="sort_order"  id="sort_order" placeholder="排序"  value="<?php if(isset($agentinfo['sort_order'])){ echo $agentinfo['sort_order'];}  ?>">
