...
<div class="content-body clearfix">
    ...
    <form class="form-horizontal" id="account-form"
          action="<?php echo $this->Url->build(array('controller' => 'Account','action'=>'postadd')); ?>"
          method="post">
        <div>
            <div class="content-operate clearfix">
                <div class="pull-left">
                    <span style="font-size: 20px;">新建用户</span>
                </div>
                ...
                <div role="tabpanel" class="tab-pane active" id="home">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select class="form-control" id="department" name="department" onchange="changeType()">
                                ...
                                <option value="<?php echo $value['id'];?>"><span><?php echo $value['name'];?></span></option>
                                <?php }?>
                                <?php }?>
                            </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6" id="date-mode-control">
                            <input type="radio" name="expire" checked="true" value="-1" /> 永久
                            <input type="radio" name="expire" value="0" /> 临时
                        </div>
                    </div>
