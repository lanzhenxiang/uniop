...
<div class="content-body clearfix">
    ...
    <script>
        ...
        function select(){
            ...
            $('#edit').attr('href','<?php echo $this->Url->build(array('controller'=>'ConsoleCategory','action'=>'addedit')); ?>/'+nodes[0].id);
            $('#delete').attr('onclick','deletes('+nodes[0].id+')');

        }
        $('#add').attr('href','<?php echo $this->Url->build(array('controller'=>'ConsoleCategory','action'=>'addedit')); ?>/');
    </script>
...
<script type="text/javascript">
    ...
    function deletes(id){
        ...
        $('#yes').one('click',function() {
            $.ajax({
                type: 'post',
                url: '<?php echo $this->Url->build(array('controller' => 'ConsoleCategory','action'=>'dele')); ?>',
                data: {id: id},
