        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <select class="form-control" id="parent_id" name="parent_id">
                    ...
                    <option value="<?php echo $key;?>" <?php if(isset($data) && $data['parent_id']==$key){ echo 'selected';}  ?>>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <select id="popedomtype" name="popedomtype" class="form-control">
                    <option value="cmop_global" <?php if(isset($data['popedomtype']) && $data['popedomtype']=='cmop_global'){ echo 'selected';}  ?> >
                        cmop_global
                    </option>
                    <option value="cmop_portal" <?php if(isset($data['popedomtype']) && $data['popedomtype']=='cmop_portal'){ echo 'selected';}  ?> >
                        cmop_portal
                    </option>
                    <option value="cmop_console" <?php if(isset($data['popedomtype']) && $data['popedomtype']=='cmop_console'){ echo 'selected';}  ?> >
                        cmop_console
                    </option>
                    <option value="cmop_admin" <?php if(isset($data['popedomtype']) && $data['popedomtype']=='cmop_admin'){ echo 'selected';}  ?> >
                        cmop_admin
                    </option>
                </select>
            </div>
