...
<div class="content-body clearfix">
    ...
    <div class="content-operate clearfix">
        <div class="pull-left">
            <a type="button" id="add"  href="<?php echo $this->Url->build(array('controller' => 'Popedomlist','action'=>'edito')); ?>" class="btn btn-addition pull-left"><i
            ...
            <?php if(isset($data)){
                foreach($data as $value){
                    ...
                    <tr>
                        ...
                        <td>
                            <a  href="<?php echo $this->Url->build(array('controller' => 'Popedomlist','action'=>'edito')); ?>/<?php if(isset($value['popedomid'])){ echo $value['popedomid'];} ?>">修改</a> |
