...
<div class="content-body clearfix">
    ...
    <form class="form-horizontal" enctype="multipart/form-data" id="console-categroy-form" action="<?php echo $this->Url->build(array('controller' => 'AdminMenu','action'=>'addedit')); ?>" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" name="sort"  id="sort" placeholder="排序"  value="<?php if(isset($department_data['sort'])){ echo $department_data['sort'];}  ?>">
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <label class="control-label  text-danger"><i class="icon-exclamation-sign">按从小到大的顺序排序。</i></label>
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <button type="submit" id="ds" class="btn btn-primary">保存</button>
                <a type="button" href="<?php echo $this->Url->build(array('controller' => 'AdminMenu','action'=>'index')); ?>" class="btn btn-danger">返回</a>
            </div>
        </div>
    </form>
</div>
