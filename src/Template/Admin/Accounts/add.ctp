            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="home">
                    ...
                    <div class="form-group">
                        ...
                        <label class="control-label text-danger"><i id="repass"></i></label>
                    </div>
                    <div class="form-group">
                        <label for="telphone" class="col-sm-2 control-label">手机号码</label>

                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="mobile" id="telphone" placeholder="手机号码">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6" id="date-mode-control">
                            <input type="radio" name="date-mode" checked="true" value="-1" /> 永久
                            <input type="radio" name="date-mode" value="0" /> 选择时间
                        </div>
                    </div>

                    <div class="form-group" id="date-mode" style="display:none;padding-top:5px;">
                        ...
                        <div class="col-sm-6">
                            <div class="input-append date" id="datetimepicker"  data-date-format="yyyy-mm-dd">
                                <input size="16" type="text" name="time" id="time"  readonly>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <?php foreach ($data as $key => $value) {
                                    ?>
                                    <input type="text" class="form-control" disabled="disabled" value="<?php echo $value['name'];?>">
                                    <input type="hidden" name="department" id="department" value="<?php echo $value['id']; ?>">
                                    <?php   } ?>
                            </select>
                        </div>
                    </div>
