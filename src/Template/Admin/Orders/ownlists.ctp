        ...
        <div class="section-header clearfix order-manage">
            ...
            <div class="dropdown pull-right">
                ...
                <ul class="dropdown-menu" id="agent_two">
                        <li><a href="<?= $this->Url->build(['prefix' => 'admin', 'controller' => 'orders', 'action' => $this->request->params['action'],$start,$end,0]); ?>?search=<?=$search?>">全部</a></li>

                        <li><a href="<?= $this->Url->build(['prefix' => 'admin', 'controller' => 'orders', 'action' => $this->request->params['action'],$start,$end,-1]); ?>?search=<?=$search?>" >未完结</a></li>

                        <li><a href="<?= $this->Url->build(['prefix' => 'admin', 'controller' => 'orders', 'action' => $this->request->params['action'],$start,$end,1]); ?>?search=<?=$search?>" >已完结</a></li>
                </ul>
            </div>
