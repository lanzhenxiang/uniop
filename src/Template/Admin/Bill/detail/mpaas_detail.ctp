...
<script type="text/javascript">
    ...
    function clickSearch(){
    	...
    	location.href="<?= $this ->Url ->build(['prefix' =>'admin', 'controller' =>'bill', 'action' =>'detail',$department_id,$type,$start,$end]);?>?vendor_code="+vendor_code+"&subject="+subject+"&column="+column+"&program_name="+program_name;
    }
</script> 	