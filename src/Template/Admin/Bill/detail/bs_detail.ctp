	...
	<div class="wrap-manage">
		...
		<div class="center clearfix">
			<div class="pull-left">
				...
				b/s工具名：&nbsp;
					<input style="margin-left:8px;margin-right:20px;line-height: 24px;height: 24px;width: 160px;" type="text" value="<?=$name?>" id="txtsearch" name="name" placeholder="">
				<?php }?>
			...
			<div class="pull-right">
				 <button class="btn btn-addition" onclick="cliskSearch()">查询</button>
			</div>
		</div>
	</div>
	<div class="wrap-manage">
		...
		<div class="center">
			...
			<div class="center clearfix bot">
				<table id="table" data-toggle="table" data-sortable="false"
				data-pagination="true"
				data-side-pagination="server"
				data-locale="zh-CN"
				data-click-to-select="true"
				data-url="<?= $this->Url->build(['prefix'=>'admin','controller'=>'bill','action'=>'detail',$department_id,$type,$start,$end]); ?>?name=<?=$name?>"
				data-unique-id="id"
				>
				<thead>
					<tr>
						<th data-field="name" >b/s工具名</th>
						<th data-field="buyer_name" >购买人</th>
						<th data-field="duration" data-formatter="formatter_duration">购买时长</th>
...
<script type="text/javascript">
    ...
    function cliskSearch(){
    	...
    	location.href="<?= $this ->Url ->build(['prefix' =>'admin', 'controller' =>'bill', 'action' =>'detail',$department_id,$type,$start,$end]);?>?name="+name;
    }
